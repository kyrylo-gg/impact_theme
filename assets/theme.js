...
import { timeline } from "//www.nasswear.com/cdn/shop/t/51/assets/vendor.min.js?v=110209841862038618801704964097";
...
import { animate, timeline as timeline2, stagger } from "//www.nasswear.com/cdn/shop/t/51/assets/vendor.min.js?v=110209841862038618801704964097";
...
import { stagger as stagger2 } from "//www.nasswear.com/cdn/shop/t/51/assets/vendor.min.js?v=110209841862038618801704964097";
...
import { animate as animate2, stagger as stagger3, inView } from "//www.nasswear.com/cdn/shop/t/51/assets/vendor.min.js?v=110209841862038618801704964097";
...
import { inView as inView2 } from "//www.nasswear.com/cdn/shop/t/51/assets/vendor.min.js?v=110209841862038618801704964097";
...
import { scroll } from "//www.nasswear.com/cdn/shop/t/51/assets/vendor.min.js?v=110209841862038618801704964097";
...
import { timeline as timeline3, inView as inView3 } from "//www.nasswear.com/cdn/shop/t/51/assets/vendor.min.js?v=110209841862038618801704964097";
...
import { animate as animate3 } from "//www.nasswear.com/cdn/shop/t/51/assets/vendor.min.js?v=110209841862038618801704964097";
...
import { animate as animate4 } from "//www.nasswear.com/cdn/shop/t/51/assets/vendor.min.js?v=110209841862038618801704964097";

// js/common/overlay/dialog-element.js
import { FocusTrap, Delegate } from "//www.nasswear.com/cdn/shop/t/51/assets/vendor.min.js?v=110209841862038618801704964097";
...
import { animate as motionAnimate, timeline as motionTimeline } from "//www.nasswear.com/cdn/shop/t/51/assets/vendor.min.js?v=110209841862038618801704964097";
...
import { animate as motionAnimate2, timeline as motionTimeline2 } from "//www.nasswear.com/cdn/shop/t/51/assets/vendor.min.js?v=110209841862038618801704964097";
...
import { Delegate as Delegate2 } from "//www.nasswear.com/cdn/shop/t/51/assets/vendor.min.js?v=110209841862038618801704964097";
...
import { animate as animate5 } from "//www.nasswear.com/cdn/shop/t/51/assets/vendor.min.js?v=110209841862038618801704964097";
...
import { animate as animate6, timeline as timeline4, stagger as stagger4 } from "//www.nasswear.com/cdn/shop/t/51/assets/vendor.min.js?v=110209841862038618801704964097";
...
import { Delegate as Delegate3 } from "//www.nasswear.com/cdn/shop/t/51/assets/vendor.min.js?v=110209841862038618801704964097";
var ProductCard = class extends HTMLElement {
  constructor() {
    ...
    this.sizeFilterRadios = document.querySelectorAll('input[name="size-filter"]');
    if (this.sizeFilterRadios.length) {
      this.productCards = this.sizeFilterRadios[0].closest('.section-stack').querySelectorAll(".product-card");
      this.productColors = this.sizeFilterRadios[0].closest('.section-stack').querySelectorAll("[data-color-sizes]");
    }
  }
  connectedCallback() {
    ...
    // Add change event listener to size filter radios
    let _this = this;
    this.sizeFilterRadios.forEach(function (radio) {
      radio.addEventListener("change", _this._filterProducts.bind(_this));
    });
  }
  disconnectedCallback() {
    this._delegate.off();
  ...
  async _onSwatchChanged(event, target) {
    ...
    let checkbox = document.getElementById('product_selector_' + this.product.handle);
    if (checkbox) {
      checkbox.value = firstMatchingVariant.id;
    }
  ...
  async _getMatchingVariant(target) {
    let selectedSize = '';
    if (this.getAttribute('data-sizes')) {
      this.sizeFilterRadios.forEach(s => {
        if (s.checked) {
    ...
    return selectedSize ? this.product["variants"].find((variant) => variant[`option${target.closest("[data-option-position]").getAttribute("data-option-position")}`] === target.value && variant[`option1`] == selectedSize) : this.product["variants"].find((variant) => variant[`option${target.closest("[data-option-position]").getAttribute("data-option-position")}`] === target.value);
  }
  async _getMatchingVariantBySize(size,card) {
    this.product = await ProductLoader.load(card.getAttribute("handle"));
    return this.product["variants"].find((variant) => variant[`option1`] === size);
  }
  async _filterProducts(event) {
    ...
    this.productColors.forEach(function (color) {
      color.style.display = "none";
    })

    // Show products that match the selected size or show all if "All" is selected
    if (selectedSize === "All") {
      this.productCards.forEach(function (card) {
        card.style.display = "block";
      });
      this.productColors.forEach(function (card) {
        card.style.display = "block";
      });
    } else {
      let _this = this;
      this.productCards.forEach(async function (card) {
        const sizes = card.getAttribute("data-sizes").split(",");
        if (sizes.includes(selectedSize)) {
          const firstMatchingVariant = await _this._getMatchingVariantBySize(selectedSize, card);
          const vId = card.querySelectorAll('#product_selector_'+card.getAttribute('handle'));

          if (vId.length) {
            vId[0].value = firstMatchingVariant.id;
          }
          card.style.display = "block";
        }
      });
      this.productColors.forEach(async function (color) {
        const sizes = color.getAttribute("data-color-sizes").split(",");
        if (sizes.includes(selectedSize)) {
...
var SalePrice = class extends HTMLElement {
  ...
  _onVariantChanged(event) {
    ...
    this.setAttribute('data-price', variant["price"]);
...
var CompareAtPrice = class extends HTMLElement {
  ...
  _onVariantChanged(event) {
    const variant = event.detail.variant;
    this.setAttribute('data-price', variant["compare_at_price"]);
...
import { PhotoSwipeLightbox } from "//www.nasswear.com/cdn/shop/t/51/assets/vendor.min.js?v=110209841862038618801704964097";
var ProductGallery = class extends HTMLElement {
  ...
  get photoswipe() {
    ...
    const photoswipe = new PhotoSwipeLightbox({
      pswpModule: () => import("//www.nasswear.com/cdn/shop/t/51/assets/photoswipe.min.js?v=23923577218600574321704964096"),
      bgOpacity: 1,
  ...
  _onVariantChanged(event) {
    ...
    let has_bundle_variant = false;
    event.detail.product.variants.forEach(v => {
      if (v.title !== undefined && v.title.includes('Bundle')) {
        has_bundle_variant = true
      }
    });
    if (has_bundle_variant ) {
      ...
      if (productSelectors.length) {
        if (event.detail.variant.title.includes('Bundle')) {
          stack.parentNode.classList.remove('hidden');
          ...
          stack.parentNode.classList.add('hidden');
          if (prevSection.classList.contains('shopify-section--impact-text')) {
...
import { animate as animate7, timeline as timeline5 } from "//www.nasswear.com/cdn/shop/t/51/assets/vendor.min.js?v=110209841862038618801704964097";
...
var VariantPicker = class extends HTMLElement {
  async connectedCallback() {
    ...
    this.courseForm = document.getElementById('course_add_form');
  ...
  selectVariant(id) {
    ...
    if (this.courseForm !== undefined && this.courseForm !== null && this.courseForm.length) {
      let courseId = document.forms['course_add_form'].id;
      courseId.value = id;
    }
...
import { inView as inView4 } from "//www.nasswear.com/cdn/shop/t/51/assets/vendor.min.js?v=110209841862038618801704964097";
...
import { timeline as timeline6 } from "//www.nasswear.com/cdn/shop/t/51/assets/vendor.min.js?v=110209841862038618801704964097";
...
import { animate as animate8 } from "//www.nasswear.com/cdn/shop/t/51/assets/vendor.min.js?v=110209841862038618801704964097";
...
import { animate as animate9 } from "//www.nasswear.com/cdn/shop/t/51/assets/vendor.min.js?v=110209841862038618801704964097";
...
// js/common/search/size-chart.js
var SizeChart = class extends Drawer {
  get shouldAppendToBody() {
    return false;
  }
};
if (!window.customElements.get("size-chart")) {
  window.customElements.define("size-chart", SizeChart);
}

// js/common/text/section-header.js
import { animate as animate10, inView as inView5 } from "//www.nasswear.com/cdn/shop/t/51/assets/vendor.min.js?v=110209841862038618801704964097";
...
// js/theme.js
import { Delegate as Delegate4 } from "//www.nasswear.com/cdn/shop/t/51/assets/vendor.min.js?v=110209841862038618801704964097";
(() => {
